...
my $output_dir = "$path/PB_AFLF/RNAi_timecourse/TGAC_kallisto_analysis/kallisto_results_bootstrap";
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/kallisto.$output";
  ...
  print SLURM "kallisto quant -i $index -o $output_dir/$output -b 100 -t 8 --pseudobam $pair_1_R1 $pair_1_R2 $pair_2_R1 $pair_2_R2 $pair_3_R1 $pair_3_R2 ../$dir2/$pair_4_R1 ../$dir2/$pair_4_R2 | samtools view -Sb - > $output_dir/$output".".bam \n";
